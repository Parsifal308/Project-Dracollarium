	...
	SubShader
	{
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float temp_output_28_0_g141 = ( ( sin( ( ( ase_worldPos.z * temp_output_99_0_g141 ) + ( ( temp_output_101_0_g141 * sin( _TimeParameters.x * 0.5 ) ) + mulTime10_g141 ) ) ) * temp_output_73_0_g141 ) * temp_output_48_0_g141 );
				float temp_output_49_0_g141 = 0.0;
				float3 appendResult63_g141 = (float3(temp_output_28_0_g141 , ( ( sin( ( ( temp_output_99_0_g141 * ase_worldPos.y ) + mulTime10_g141 ) ) * temp_output_73_0_g141 ) * temp_output_49_0_g141 ) , temp_output_28_0_g141));
				...
				outputPackedVaryingsMeshToPS.ase_texcoord6 = vertexToFrag18_g134;
						...
						)
			{
				...
				float4 vertexToFrag18_g134 = packedInput.ase_texcoord6;
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh  )
			{
				...
				float4 lerpResult19_g134 = lerp( temp_cast_2 , lerpResult17_g134 , AG_TintToggle);
				float4 vertexToFrag18_g134 = lerpResult19_g134;
				outputPackedVaryingsMeshToPS.ase_texcoord3 = vertexToFrag18_g134;
				float3 ase_worldTangent = TransformObjectToWorldDir(inputMesh.tangentOS.xyz);
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float4 tex2DNode162 = tex2D( _MainTex, uv_MainTex162 );
				float4 vertexToFrag18_g134 = packedInput.ase_texcoord3;
				half4 TintColor1462 = vertexToFrag18_g134;
				float4 temp_output_163_0 = ( _Color * tex2DNode162 * TintColor1462 );
		...
		Pass
		{
			...
			AttributesMesh ApplyMeshModification(AttributesMesh inputMesh, float3 timeParameters, inout PackedVaryingsMeshToPS outputPackedVaryingsMeshToPS )
			{
				...
				float4 lerpResult19_g134 = lerp( temp_cast_2 , lerpResult17_g134 , AG_TintToggle);
				float4 vertexToFrag18_g134 = lerpResult19_g134;
				outputPackedVaryingsMeshToPS.ase_texcoord8 = vertexToFrag18_g134;
				float3 ase_worldNormal = TransformObjectToWorldNormal(inputMesh.normalOS);
				float3 ase_worldTangent = TransformObjectToWorldDir(inputMesh.tangentOS.xyz);
				float ase_vertexTangentSign = inputMesh.tangentOS.w * unity_WorldTransformParams.w;
				float3 ase_worldBitangent = cross( ase_worldNormal, ase_worldTangent ) * ase_vertexTangentSign;
						...
						)
			{
				...
				float4 tex2DNode162 = tex2D( _MainTex, uv_MainTex162 );
				float4 vertexToFrag18_g134 = packedInput.ase_texcoord8;
				half4 TintColor1462 = vertexToFrag18_g134;
				float4 temp_output_163_0 = ( _Color * tex2DNode162 * TintColor1462 );
...
/*ASEBEGIN
Version=18935
1920;80;1906;820;9711.922;3032.745;6.64255;True;False
...
Node;AmplifyShaderEditor.Vector3Node;1374;-1536,1280;Half;False;Global;AGW_WindDirection;AGW_WindDirection;20;0;Create;True;0;0;0;False;0;False;0,0,0;-0.9362568,-0.3420201,0.08028412;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.RangedFloatNode;914;-5248,-1888;Half;False;Global;AG_TreesAO;AG_TreesAO;21;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.NormalizeNode;136;-1408,-640;Inherit;False;False;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.StaticSwitch;364;-4480,-640;Float;False;Property;_EnableWorldProjection;Enable World Projection;31;0;Create;True;0;0;0;False;1;Header(Projection);False;0;1;1;True;;Toggle;2;Key0;Key1;Create;True;True;All;9;1;FLOAT3;0,0,0;False;0;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT3;0,0,0;False;5;FLOAT3;0,0,0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.FunctionNode;1656;-3968,1280;Inherit;False;AG Global Wind - Tree;-1;;141;b3a3869a2b12ed246ae10bcce7d41e6e;0;6;48;FLOAT;0;False;49;FLOAT;0;False;96;FLOAT;1;False;94;FLOAT;1;False;95;FLOAT;1;False;97;FLOAT;1;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1811;640,-2176;Float;False;True;-1;2;Rendering.HighDefinition.LitShaderGraphGUI;0;2;ANGRYMESH/Nature Pack/HDRP/Tree Leaf Snow;53b46d85872c5b24c8f4f0a1c3fe4c87;True;GBuffer;0;0;GBuffer;35;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;True;7;d3d11;metal;vulkan;xboxone;xboxseries;playstation;switch;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;0;True;-25;False;False;False;False;False;False;False;False;False;True;True;0;True;-13;255;False;-1;255;True;-12;7;False;-1;3;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;False;True;0;True;-14;False;True;1;LightMode=GBuffer;False;False;0;;0;0;Standard;42;Surface Type;0;0;  Rendering Pass;1;0;  Refraction Model;0;0;    Blending Mode;0;0;    Blend Preserves Specular;1;0;  Receive Fog;1;0;  Back Then Front Rendering;0;0;  Transparent Depth Prepass;0;0;  Transparent Depth Postpass;0;0;  Transparent Writes Motion Vector;0;0;  Distortion;0;0;    Distortion Mode;0;0;    Distortion Depth Test;1;0;  ZWrite;0;0;  Z Test;4;0;Double-Sided;1;0;Alpha Clipping;1;0;  Use Shadow Threshold;0;0;Material Type,InvertActionOnDeselection;5;0;  Energy Conserving Specular;1;0;  Transmission;1;0;Receive Decals;1;0;Receives SSR;1;0;Receive SSR Transparent;0;0;Motion Vectors;0;0;  Add Precomputed Velocity;0;0;Specular AA;0;0;Specular Occlusion Mode;1;0;Override Baked GI;0;0;Depth Offset;0;0;DOTS Instancing;1;637860644902263918;LOD CrossFade;1;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,-1;0;  Type;0;0;  Tess;16,False,-1;0;  Min;10,False,-1;0;  Max;25,False,-1;0;  Edge Length;16,False,-1;0;  Max Displacement;25,False,-1;0;Vertex Position;1;0;0;12;True;True;True;True;True;True;False;False;False;False;True;True;False;;False;0
...
ASEEND*/
//CHKSM=9124A47C286E91CFFE4E119957896A61767316DF