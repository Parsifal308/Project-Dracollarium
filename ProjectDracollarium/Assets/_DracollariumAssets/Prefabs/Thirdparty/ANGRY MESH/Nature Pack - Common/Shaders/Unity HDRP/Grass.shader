	...
	SubShader
	{
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh  )
			{
				...
				float4 lerpResult19_g33 = lerp( temp_cast_2 , lerpResult17_g33 , AG_TintToggle);
				float4 vertexToFrag18_g33 = lerpResult19_g33;
				outputPackedVaryingsMeshToPS.ase_texcoord3 = vertexToFrag18_g33;
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float4 tex2DNode1 = tex2D( _MainTex, uv_MainTex1 );
				float4 vertexToFrag18_g33 = packedInput.ase_texcoord3;
				half4 TintColor229 = vertexToFrag18_g33;
				float4 temp_output_33_0 = ( _Color * tex2DNode1 * TintColor229 );
				float4 lerpResult8 = lerp( ( _BaseBottomColor * temp_output_33_0 ) , temp_output_33_0 , saturate( pow( abs( ( packedInput.ase_color.r * 2.0 ) ) , _BaseBottomOffset ) ));
				half4 Output_Albedo97 = lerpResult8;
...
/*ASEBEGIN
Version=18935
1920;80;1906;820;245.3713;1297.677;1;True;False
...
Node;AmplifyShaderEditor.Vector3Node;241;-1152,704;Half;False;Global;AGW_WindDirection;AGW_WindDirection;20;0;Create;True;0;0;0;False;0;False;0,0,0;-0.9362568,-0.3420201,0.08028412;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
ASEEND*/
//CHKSM=0D3405AB47586FAF10A5FB3146F4DD84DA3EADD4