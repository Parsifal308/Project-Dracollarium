...
public class PlayerManager : MonoBehaviour {
    ...
    [SerializeField] private PlayerInput playerInput; //REFACTORIZAR, algunas cosas usan esto todavia en vez del Character Movement player action
     [Tooltip("Inputs corresponding to player actions are registered, such as interacting, dropping, picking up, etc.")]
    [SerializeField] private PlayerActions_Actions controller_PlayerActions_Actions;
    [Tooltip("Inputs corresponding to actions such as positioning, rotating, scaling furniture and walls")]
    [SerializeField] private PlayerActions_Building controller_PlayerActions_Building;
    [Tooltip("Inputs corresponding to the movement of the character are registered: move sideways, jump, rotate the camera.")]
    [SerializeField] private PlayerActions_CharacterMovement controller_PlayerActions_Movement;
    [Tooltip("Inputs corresponding to the UI controls")]
    [SerializeField] private PlayerActions_Menu controller_PlayerActions_Menu;
    [Tooltip("Inputs corresponding to the combat controls")]
    [SerializeField] private PlayerActions_PlayerCombat controller_PlayerActions_Combat;
    ...
    #region PROPERTIES
    public PlayerActionsController PlayerActionsController{get{return playerActionsController;}}
    ...
    public PlayerActions_Actions Controller_PlayerActions_Actions { get { return controller_PlayerActions_Actions; } }
    public PlayerActions_CharacterMovement Controller_PlayerActions_CharacterMovement { get { return controller_PlayerActions_Movement; } }
    public PlayerActions_Building Controller_PlayerActions_Building { get { return controller_PlayerActions_Building; } }
    ...
    private void Awake(){
        ...
        controller_PlayerActions_Actions = GetComponent<PlayerActions_Actions>();
        controller_PlayerActions_Building = GetComponent<PlayerActions_Building>();
        controller_PlayerActions_Movement = GetComponent<PlayerActions_CharacterMovement>();
        controller_PlayerActions_Menu = GetComponent<PlayerActions_Menu>();
        controller_PlayerActions_Combat = GetComponent<PlayerActions_PlayerCombat>();
