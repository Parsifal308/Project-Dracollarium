	...
	SubShader
	{
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh  )
			{
				...
				float4 lerpResult19_g1 = lerp( temp_cast_0 , lerpResult17_g1 , AG_TintToggle);
				float4 vertexToFrag18_g1 = lerpResult19_g1;
				outputPackedVaryingsMeshToPS.ase_texcoord3 = vertexToFrag18_g1;
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float4 tex2DNode162 = tex2D( _MainTex, uv_MainTex162 );
				float4 vertexToFrag18_g1 = packedInput.ase_texcoord3;
				half4 TintColor1115 = vertexToFrag18_g1;
				half4 Output_Albedo1074 = ( _Color * tex2DNode162 * TintColor1115 );
...
/*ASEBEGIN
Version=18935
1920;80;1906;820;3254.416;2295.962;3.162939;True;False
...
ASEEND*/
//CHKSM=56FD69008B882B6ABF6B393A8939475D851A5F7F