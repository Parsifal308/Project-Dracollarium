...
public class PlayerMovement_Shoulder : MonoBehaviour , IMovement{
    ...
    private void Start(){
        ...
        OnPlayerMovement += playerGlobalController.PlayerDracollariumAnimation.SetMovementAnimationBoolean;
